...
def insert_image():
  ...
  # plant_array = [[10, 12, 16], [12, 16, 17], [10, 17, 12]]
  ...
  cell_width = slide_width / num_cols
  cell_height = slide_height / num_rows
  ...
  for row in range(num_rows):
    for col in range(num_cols):
      ...
      image_x_position_in_points = (col * cell_width) + (cell_width / 2)
      image_y_position_in_points = (row * cell_height) + (cell_height / 2)
      ...
      requests = [
        {
            'createImage': {
                ...
                'elementProperties': {
                    ...
                    'size': {
                        'height': {
                            'magnitude': image_height_in_pixels,
                            'unit': 'PT'  # Points
                        },
                        'width': {
                            'magnitude': image_width_in_pixels,
                            'unit': 'PT'  # Points
                        }
                    },
                    'transform': {
                        'scaleX': 1.0,
                        'scaleY': 1.0,
                        'translateX': image_x_position_in_points,
                        'translateY': image_y_position_in_points,
                        'unit': 'PT'
                    }
                },
                'url': image_url,
