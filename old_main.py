...
def insert_image():
    ...
    presentation_id = '1us_-w4_Asq6latJZAc5v1KbEQIRLd3OFUUps1mt6ufw'
    # The URL of the image to insert.
    image_url = 'https://lh3.googleusercontent.com/VBe3omqtaBtOiJ7Dkj6mDhIYyU6MDkF3OqMj0IvQby9YssT
uuzS3Og1ZMFVAnHAgKBBkgAb87bW5Z2VpjrHOJb1AXNO8cQEyRJbrFYjsYiuSUD6lvZz_d94
7aLIZsdfwyA=w1280'
    # The name of the slide to insert the image into
    slide_name = 'g23bc07087f1_0_0'
